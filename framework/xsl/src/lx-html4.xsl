...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
	...
	<meta http-equiv="Content-Type" content="text/html;charset=UTF-8"/>
        ...
        <!-- CSS -->
        <xsl:apply-templates select="$LX_HTML_HEAD/*[.//lx.html:stylesheet]"/>

        <!-- JavaScript -->
        <xsl:apply-templates select="$LX_HTML_HEAD/*[.//lx.html:javascript]"/>
        ...
        <xsl:apply-templates select="$LX_HTML_HEAD/*
                                     [name()!='title']
                                     [not(descendant::lx.html:stylesheet)]
                                     [not(descendant::lx.html:javascript)]"/>
