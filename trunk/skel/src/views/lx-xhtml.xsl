...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <html>
      <head>
	<xsl:comment>Page generated by LX. See http://lx.promethe.net for more info.</xsl:comment>
  ...
  <!--
    ...
    -->
  <xsl:template match="lx:link[@controller or @module]"
    ...
    <!-- @param content of the link (string | nodeset)-->
